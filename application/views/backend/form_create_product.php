						...
						<?=  form_open_multipart('admin/products/create',['class'=>'form-group']) ?>
							<div class="col-sm-4">
								<div class="input-group">
									<div class="input-group-addon">Catagory</div>
									<input type="text" class="form-control" name="pro_name" placeholder="Enter Product catagory" value="<?= set_value('pro_name') ?>">
								</div>
							</div>
							...
							<div class="col-sm-4">
								<div class="input-group">
									...
									<input type="text" class="form-control" name="pro_title" placeholder="Enter Product Name" value="<?= set_value('pro_title') ?>">
								</div>
							</div>
							...
							<div class="col-sm-4">
								<div class="input-group col-sm-12">
									<textarea rows="4" class="form-control" name="pro_description" placeholder="Enter Product Description"><?= set_value('pro_description') ?></textarea>
								</div>
							</div>
