							...
							<table class="table table-striped table-hover" id="tableproducts">
								...
								<?php foreach ($products as $product ) : ?>
									<tr>
										...
										<td>
											<a href="">
												<style>#g {width:200px;height:100px;}</style>
												<?php
										...
										<td>
											<?=  anchor('admin/products/edit/'.$product->pro_id,'update',['class'=>'btn btn-success btn-xs']) ?>
											<?php  if($this->session->userdata('group')	==	'1' ): ?>
											<?=  anchor('admin/products/delete/'.$product->pro_id,'delete.',['class'=>'btn btn-danger btn-xs','onclick'=>'return confirm(\'Are You Sure ? \')']) ?>
											<?php else:?>
